...
SECRET_KEY = 'django-insecure-fyxw1m+muhe2gw8mo^2wlykrdmi6rf75q8!&a9)c)q1!38+a07'
...
ROOT_URLCONF = 'LandRentBackend.urls'
...
WSGI_APPLICATION = 'LandRentBackend.wsgi.application'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=1),  # Set access token expiry to 1 hour
